...
@Component({
  selector: 'app-juegos-display-admin',
  templateUrl: './juegos-display-admin.component.html',
  styleUrls: ['./juegos-display-admin.component.css']
})
export class JuegosDisplayAdminComponent implements OnChanges{
