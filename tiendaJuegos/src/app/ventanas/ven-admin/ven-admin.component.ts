...
@Component({
  selector: 'app-ven-admin',
  templateUrl: './ven-admin.component.html',
  styleUrls: ['./ven-admin.component.css']
})
export class VenAdminComponent {
  ...
  constructor(private rutedor:Router, private vidApi: VideojuegosApiService, private resApi: ReservasApiService, private compApi: ComprasApiService) {
